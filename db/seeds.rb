...
Favorite.create(artist_id: lorie.id, instrument_id: harp_1.id)
Favorite.create(artist_id: jacques.id, instrument_id: accordion.id)
Favorite.create(artist_id: lorie.id, instrument_id: clarinet.id)
Favorite.create(artist_id: jean.id, instrument_id: harp_2.id)
Favorite.create(artist_id: crysta.id, instrument_id: accordion.id)
